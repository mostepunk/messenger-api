...
Revision ID: 20250527182423
Revises: 20250219193149
Create Date: 2025-05-27 18:24:23.955399
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_profile_account_id'), 'profile', ['account_id'], unique=True)
